  ...
  render: (args) => (
    <DropdownMenu>
      ...
      <DropdownMenuContent {...args}>
        <DropdownMenuItem className="gap-2">Light</DropdownMenuItem>
        <DropdownMenuItem className="gap-2">Dark</DropdownMenuItem>
        <DropdownMenuItem className="gap-2">System</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  ),
  args: {
